...
public final class PaymentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.eBank.payments.PaymentRequest,
      grpc.eBank.payments.UpdateBalanceResponse> getSendMutliplePaymentsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMutliplePayments",
  ...
  public static io.grpc.MethodDescriptor<grpc.eBank.payments.PaymentRequest,
      grpc.eBank.payments.UpdateBalanceResponse> getSendMutliplePaymentsMethod() {
    io.grpc.MethodDescriptor<grpc.eBank.payments.PaymentRequest, grpc.eBank.payments.UpdateBalanceResponse> getSendMutliplePaymentsMethod;
    if ((getSendMutliplePaymentsMethod = PaymentServiceGrpc.getSendMutliplePaymentsMethod) == null) {
      synchronized (PaymentServiceGrpc.class) {
        if ((getSendMutliplePaymentsMethod = PaymentServiceGrpc.getSendMutliplePaymentsMethod) == null) {
          PaymentServiceGrpc.getSendMutliplePaymentsMethod = getSendMutliplePaymentsMethod = 
              ...
              .setFullMethodName(generateFullMethodName(
                  "payments.PaymentService", "sendMutliplePayments"))
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new PaymentServiceMethodDescriptorSupplier("sendMutliplePayments"))
                  .build();
          }
        }
     }
     return getSendMutliplePaymentsMethod;
  }
  ...
  public static abstract class PaymentServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<grpc.eBank.payments.PaymentRequest> sendMutliplePayments(
        io.grpc.stub.StreamObserver<grpc.eBank.payments.UpdateBalanceResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getSendMutliplePaymentsMethod(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getSendMutliplePaymentsMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                grpc.eBank.payments.PaymentRequest,
                grpc.eBank.payments.UpdateBalanceResponse>(
                  this, METHODID_SEND_MUTLIPLE_PAYMENTS)))
          .build();
    }
  }
  ...
  public static final class PaymentServiceStub extends io.grpc.stub.AbstractStub<PaymentServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<grpc.eBank.payments.PaymentRequest> sendMutliplePayments(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getSendMutliplePaymentsMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_SEND_MUTLIPLE_PAYMENTS = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_SEND_MUTLIPLE_PAYMENTS:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.sendMutliplePayments(
              (io.grpc.stub.StreamObserver<grpc.eBank.payments.UpdateBalanceResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
      ...
      synchronized (PaymentServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getSendMutliplePaymentsMethod())
              .build();
        }
      }
    }
