...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return grpc.eBank.login.LoginServiceImpl.internal_static_login_LoginResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return grpc.eBank.login.LoginServiceImpl.internal_static_login_LoginResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            grpc.eBank.login.LoginResponse.class, grpc.eBank.login.LoginResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof grpc.eBank.login.LoginResponse)) {
      return super.equals(obj);
    }
    grpc.eBank.login.LoginResponse other = (grpc.eBank.login.LoginResponse) obj;
  ...
  public static grpc.eBank.login.LoginResponse parseFrom(
  ...
  public static grpc.eBank.login.LoginResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static grpc.eBank.login.LoginResponse parseFrom(
  ...
  public static grpc.eBank.login.LoginResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static grpc.eBank.login.LoginResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static grpc.eBank.login.LoginResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(grpc.eBank.login.LoginResponse prototype) {
  ...
  public static final class Builder extends
      ...
      grpc.eBank.login.LoginResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return grpc.eBank.login.LoginServiceImpl.internal_static_login_LoginResponse_descriptor;
    }
    ...
    // Construct using grpc.eBank.login.LoginResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public grpc.eBank.login.LoginResponse getDefaultInstanceForType() {
      return grpc.eBank.login.LoginResponse.getDefaultInstance();
    }

    @java.lang.Override
    public grpc.eBank.login.LoginResponse build() {
      grpc.eBank.login.LoginResponse result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof grpc.eBank.login.LoginResponse) {
        return mergeFrom((grpc.eBank.login.LoginResponse)other);
      } else {
    ...
    public Builder mergeFrom(grpc.eBank.login.LoginResponse other) {
      if (other == grpc.eBank.login.LoginResponse.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      grpc.eBank.login.LoginResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (grpc.eBank.login.LoginResponse) e.getUnfinishedMessage();
  ...
  private static final grpc.eBank.login.LoginResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new grpc.eBank.login.LoginResponse();
  }

  public static grpc.eBank.login.LoginResponse getDefaultInstance() {
