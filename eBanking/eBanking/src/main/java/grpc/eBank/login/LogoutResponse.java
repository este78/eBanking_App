...
/**
 * Protobuf type {@code login.LogoutResponse}
 */
public  final class LogoutResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:login.LogoutResponse)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return grpc.eBank.login.LoginServiceImpl.internal_static_login_LogoutResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return grpc.eBank.login.LoginServiceImpl.internal_static_login_LogoutResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            grpc.eBank.login.LogoutResponse.class, grpc.eBank.login.LogoutResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof grpc.eBank.login.LogoutResponse)) {
      return super.equals(obj);
    }
    grpc.eBank.login.LogoutResponse other = (grpc.eBank.login.LogoutResponse) obj;
  ...
  public static grpc.eBank.login.LogoutResponse parseFrom(
  ...
  public static grpc.eBank.login.LogoutResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static grpc.eBank.login.LogoutResponse parseFrom(
  ...
  public static grpc.eBank.login.LogoutResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static grpc.eBank.login.LogoutResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static grpc.eBank.login.LogoutResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(grpc.eBank.login.LogoutResponse prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:login.LogoutResponse)
      grpc.eBank.login.LogoutResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return grpc.eBank.login.LoginServiceImpl.internal_static_login_LogoutResponse_descriptor;
    }
    ...
    // Construct using grpc.eBank.login.LogoutResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public grpc.eBank.login.LogoutResponse getDefaultInstanceForType() {
      return grpc.eBank.login.LogoutResponse.getDefaultInstance();
    }

    @java.lang.Override
    public grpc.eBank.login.LogoutResponse build() {
      grpc.eBank.login.LogoutResponse result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof grpc.eBank.login.LogoutResponse) {
        return mergeFrom((grpc.eBank.login.LogoutResponse)other);
      } else {
    ...
    public Builder mergeFrom(grpc.eBank.login.LogoutResponse other) {
      if (other == grpc.eBank.login.LogoutResponse.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      grpc.eBank.login.LogoutResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (grpc.eBank.login.LogoutResponse) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    // @@protoc_insertion_point(builder_scope:login.LogoutResponse)
  }

  // @@protoc_insertion_point(class_scope:login.LogoutResponse)
  private static final grpc.eBank.login.LogoutResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new grpc.eBank.login.LogoutResponse();
  }

  public static grpc.eBank.login.LogoutResponse getDefaultInstance() {
